...
func (x *GetServerStatusResponse) GetCommit() string {
	if x != nil {
		return x.Commit
	}
	return ""
...
func (x *GetServerStatusResponse) GetBuildDate() string {
	if x != nil {
		return x.BuildDate
	}
	return ""
...
const file_proto_dmanager_v1_auth_proto_rawDesc = "" +
	...
	"\x16GetServerStatusRequest\"\xee\x01\n" +
