...
* **Gotify Integration:** The system must support sending notifications to a Gotify server when newer container image updates are detected or when automatic container re-deployments are executed.
