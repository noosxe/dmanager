...
```mermaid
graph TD
    S1[STORY-001: DB Schema & Migrations] --> S2[STORY-002: Backend Authentication]
...
### STORY-001: DB Schema, Migration Setup & SQLC CodeGen
...
### STORY-004: Docker Client Setup & Basic Container Listing
